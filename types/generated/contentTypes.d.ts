...
export interface ApiAboutAbout extends Schema.SingleType {
  ...
  attributes: {
    ...
    category: Attribute.Enumeration<['t shirt', 'mug', 'stickers', 'hoodie']> &
      Attribute.Required &
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    image: Attribute.Media & Attribute.Required;
    category: Attribute.Enumeration<['t-shits', 'mug', 'hoodie', 'stickers']> &
      Attribute.DefaultTo<'t-shits'>;
    size: Attribute.String &
      Attribute.SetMinMaxLength<{
        minLength: 3;
        maxLength: 70;
      }>;
    color: Attribute.Enumeration<['green', 'red ', 'blue', 'black', 'white ']>;
    price: Attribute.Integer & Attribute.Required;
